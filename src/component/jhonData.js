const jhonData = {
          ...
          menuItems: [
            {
              id: 1,
              icon: 'icon_pin_alt',
              text: 'Direccion: Cra. 41 #9-60',
              link:"https://goo.gl/maps/3MXbSeuhaMmvxf1y9"
            },
            {
              id: 2,
              icon: 'icon_phone',
              text: 'Telefono: (+57) 312 617 8969',
              link:"https://api.whatsapp.com/send?phone=573126178969"
            },
            {
              id: 3,
              icon: 'icon_mail',
              text: 'Correo: contacto@grupopineal.com',
              link:"mailto:contacto@grupopineal.com"
            },
            // {
            //   id: 4,
            //   icon: 'icon_globe',
    ...
    contacttitle: 'Envíanos tu pregunta',
}
